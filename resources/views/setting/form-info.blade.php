<fieldset class="mb-3">
    ...
    <x-playground::forms.column column="setting_type" label="Setting Type" :rules="['maxlength' => 255]" />

    @if (!empty($parents))
        <x-playground::forms.column-select column="parent_id" key="title" label="Parent Setting" :records="$parents" />
    @endif
